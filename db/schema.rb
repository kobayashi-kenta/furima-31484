...
ActiveRecord::Schema.define(version: 20_201_109_111_450) do
  ...
  create_table 'items', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8', force: :cascade do |t|
    ...
    t.integer 'money_type_id', null: false
  ...
  create_table 'users', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8', force: :cascade do |t|
    ...
    t.string 'last_name_1', null: false
    t.string 'first_name_1', null: false
    t.string 'last_name_2', null: false
    t.string 'first_name_2', null: false
